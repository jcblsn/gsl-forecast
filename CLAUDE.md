...
- Use active voice.
- Use present tense.
- Give each word one approved meaning and use it that way only.
- Use the same word for the same thing every time; do not use synonyms.
- Do not use noun clusters longer than three words.
- State warnings and conditions before the instruction they apply to.
